...
# " [\#number](https://github.com/ftlnetwork/ftlnetwork-sdk/issues/<number>)
...
for line in fileinput.input(inplace=1):
    line = re.sub(r"\s\\#([0-9]*)", r" [\\#\1](https://github.com/ftlnetwork/ftlnetwork-sdk/issues/\1)", line.rstrip())
    print(line)