...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/ftlnetwork/ftlnetwork-sdk/tree/master/CONTRIBUTING.md)
...
[master](https://github.com/ftlnetwork/ftlnetwork-sdk/tree/master/docs)
and [develop](https://github.com/ftlnetwork/ftlnetwork-sdk/tree/develop/docs),
respectively.
...
Then, edit the `swagger.yaml` manually; it is found [here](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/develop/client/lcd/swagger-ui/swagger.yaml)
