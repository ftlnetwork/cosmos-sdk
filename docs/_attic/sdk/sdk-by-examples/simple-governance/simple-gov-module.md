...
**File: [`x/simple_governance/types.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/types.go)**
...
**File: [`x/simple_governance/keeper.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/keeper.go)**
...
This function is called from the main [`app.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/app/app.go) file to instanciate a new `Keeper`. A similar function exits for `KeeperRead`.
...
*Note: If you look at the code, you'll notice that the context `ctx` is a parameter of many of the methods. The context `ctx` provides useful information on the current state such as the current block height and allows the keeper `k` to access the `KVStore`. You can check all the methods of `ctx` [here](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/develop/types/context.go#L144-L168)*.

## Handler 

**File: [`x/simple_governance/handler.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/handler.go)**
...
The function returns a `Result` that is returned to the application. It contains several useful information such as the amount of `Gas` for this transaction and wether the message was succesfully processed or not. At this point, we exit the boundaries of our simple governance module and go back to root application level. The `Result` will differ from application to application. You can check the `sdk.Result` type directly [here](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/develop/types/result.go) for more info.
...
**File: [`x/simple_governance/codec.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/codec.go)**
...
**File: [`x/simple_governance/errors.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/errors.go)**
...
**File: [`x/simple_governance/client/cli/simple_governance.go`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/client/cli/simple_governance.go)**
...
**File: [`x/simple_governance/client/rest/simple_governance.goo`](https://github.com/ftlnetwork/ftlnetwork-sdk/blob/fedekunze/module_tutorial/examples/simpleGov/x/simple_governance/client/rest/simple_governance.go)**

The Rest Server, also called [Light-Client Daemon (LCD)](https://github.com/ftlnetwork/ftlnetwork-sdk/tree/master/client/lcd), provides support for **HTTP queries**.
