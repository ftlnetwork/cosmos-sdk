...
[x/auth](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/auth) and
[x/bank](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/bank) API documentation.
...
docs](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/auth#AccountKeeper) for more information.
...
docs](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/bank#Keeper) for the full set of methods.

Note we can refine the `bank.Keeper` by restricting it's method set. For
instance, the
[bank.ViewKeeper](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/bank#ViewKeeper)
is a read-only version, while the
[bank.SendKeeper](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/bank#SendKeeper)
...
[x/bank API docs](https://godoc.org/github.com/ftlnetwork/ftlnetwork-sdk/x/bank)
for more details.
